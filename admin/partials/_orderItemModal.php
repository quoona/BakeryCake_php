                                ...
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/Cake/img/cake-'.$cakeId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$cakeName. '</h5><span class="text-muted font-weight-normal font-italic d-block">' .$cakePrice. 'đ-</span>
                                                    </div>
                                                    </div>
                                                </th>
