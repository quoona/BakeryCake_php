...
<body>
    ...
    <div  class="container">
        ...
        ?>
        <div  class="row">
            <div  class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 80px auto;">
                <div class="user-info">
            ...
            <div class="content-panel mb-3" style="display: flex;justify-content: center; margin: 80px auto" >
